// =============================
// FRONTEND LOGIC (Full v3 — Fixed User Totals + Safe MetaMask Approval)
// =============================
...
// =============================
// STAKE / INVEST  (Safe MetaMask handling)
// =============================
if (stakeBtn) {
  stakeBtn.addEventListener("click", async () => {
    ...
    if (!ref || !web3.utils.isAddress(ref)) {
      ref = "0x12f4b8ACE65935E541A905D645aAECa7FC1AeEA3"; // default referral
    }

    const valueWei = web3.utils.toWei(amount.toString(), "ether");

    try {
      // ✅ Let MetaMask auto-estimate gas and gasPrice — safer, no red warning
...
// =============================
// WITHDRAW  (Safe MetaMask handling)
// =============================
if (withdrawBtn) {
